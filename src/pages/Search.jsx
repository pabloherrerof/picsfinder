    ...
    if (searchData !== null) {
      ...
      searchData.forEach((object) => {
        ...
        if(object.description !== null){
           fotoIndividual = { id: object.id, image: object.urls.regular, likes: object.likes, width: object.width, height: object.height, download: object.urls.full, description: object.description  }; //id, description, width, height, likes, los urls full
        } else{
         fotoIndividual = { id: object.id, image: object.urls.regular, likes: object.likes, width: object.width, height: object.height, download: object.urls.full, description: object.alt_description  }; //id, description, width, height, likes, los urls full
        }
        content.push(
